  ...
  <section id="annonce">
            ...
            <div class="col">
                ...
                <div class="card hovercard">
                    ...
                    <div class="card-body">
                      <h5 class="card-title">
                        <?php echo $annonce->nom_inf." ".$annonce->prenom_inf ;
                        ?> 
                      </h5>
                      <p class="card-text">
                        <?php
                        echo "Je suis disponible du :".$annonce->heure_deb . "jusqu'a :".$annonce->heure_fin."<br>";
                        echo "Pour m'appeler Voice mon numero :".$annonce->numtel_inf ;
                        ?>
                    </p>
