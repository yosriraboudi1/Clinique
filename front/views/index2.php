...
<body>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link" href="#"><i class="bi bi-house-door-fill"></i>&nbsp;Acceuil</a>
              </li>
              <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="page_annonce.php"><i class="bi bi-megaphone-fill"></i>&nbsp;Annonces</a>
          </li>

           <li class="nav-item">
                <a class="nav-link" href="product_list.php"><i class="bi bi-cart-fill"></i>&nbsp;Produits</a>
          </li>
    ...
    function hid_function_x(){
        var div_login=document.getElementById("x");
        var div_signup=document.getElementById("y");
