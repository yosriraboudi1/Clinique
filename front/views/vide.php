...
<a href="Wapi_Accueil.html" class="logo"><img alt="" src="images/l.png" class="img-responsive"></a>
</div>
...
<table class="table table-bordered table-striped mb-none"  >
                            <thead>
                                <tr>
                                                    ...
                                                    <th style="color:rgb(131, 41, 148)">Contenu</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
 <form method="POST" action="contt.php"></form>
                                              <form method="POST" action="contt.php">
                                                    <button name="contenu" ><img width="30px" src="images/eee.png"></button>
                                        ...
                                        <td><?php echo $row["lieuLivraison"] ; ?></td>
                                               ...
                                               <td>
                                                    ...
                                                    <form method="POST" action="imprimermescommandes.php">
...
<div class="nums bold">
<p>+216 94 305 426<br></p>
</div>
<p class="coor_mail">wapi.commercial@gmail.com</p>
</div>
<div class="sep_dotted">&nbsp;</div>
<div class="rs_footer">
<p class="title_footer">Suivez nous sur </p>
<div class="list_rs">
<a href="https://www.facebook.com/Wapi-1909964879236073/" target="_blank" class="item_rs_footer"><em class="fab fa-facebook-f" aria-hidden="true"></em></a>
...
<div class="copyright">
Copyright © 2019 Wapi , Tous droits réservés. Site Web réalisé par Minds Blowers
</div>
</div>
</div>
<div id="cd-menu">
<div class="rs_lang"><div id="ctl28_pnl_WG_SectionSelecor">
		
    <div id="ctl28_upnl_Widget">
			
            <div id="langselector">
                <div id="ctl28_pnl_Widget_Frame">
				<div>
					<div id="ctl28_pnl_SelectorPanel" class="select_lang">
						<div class="dropdown"><button class="lang lang_hover" type="button" data-toggle="dropdown"><img src="http://www.meubleskarray.com/fr/promotions" class="icon_lang">FR<span class="caret"></span></button><ul class="dropdown-menu list_lang"><li><a href="http://www.meubleskarray.com/fr/promotions" class="lang"><img src="http://www.meubleskarray.com/fr/promotions" class="icon_lang">FR</a></li><li><a href="http://www.meubleskarray.com/en/Promotions_en" class="lang"><img src="http://www.meubleskarray.com/fr/promotions" class="icon_lang">EN</a></li></ul></div>
					</div>
				</div>
			</div>
            </div>
...
<div class="main_menu_responsive"><div id="ctl20_pnl_Menu_3">
		
    <div id="menu_rsp">
        <div id="ctl20_pnl_Main_Frame">
			
            <div id="ctl20_rm_Menu_3" class="RadMenu RadMenu_Metro rmSized menurs" style="height: 0px; width: 0px; z-index: 7000;">
				<ul class="rmRootGroup rmToggleHandles rmVertical">
					<li class="rmItem rmFirst"><a class="rmLink rmRootLink item" href="Wapi_Accueil.html"><span class="rmText">Accueil</span></a></li><li class="rmItem "><a class="rmLink rmRootLink item" href="http://www.meubleskarray.com/fr/presentation"><span class="rmText">Présentation</span></a></li><li class="rmItem  subitem"><a class="rmLink rmRootLink item" href="http://www.meubleskarray.com/fr/promotions#"><span class="rmText rmExpandRight">Produits</span><span class="rmToggle"><span class="rmIcon">Toggle</span></span></a><div class="rmSlide">
					...
					</div></li><li class="rmItem "><a class="rmLink rmRootLink item" href="http://www.meubleskarray.com/fr/showroom"><span class="rmText">Showroom</span></a></li><li class="rmItem "><a class="rmLink rmRootLink item rmSelected item_hover" href="http://www.meubleskarray.com/fr/promotions"><span class="rmText">Promotions</span></a></li><li class="rmItem rmLast"><a class="rmLink rmRootLink item" href="http://www.meubleskarray.com/fr/nos_references"><span class="rmText">Nos références</span></a></li>
				</ul><script type="text/javascript">
					Telerik.Web.UI.RadMenu._adjustRootItemWidth("ctl20_rm_Menu_3");
				</script><input id="ctl20_rm_Menu_3_ClientState" name="ctl20_rm_Menu_3_ClientState" type="hidden" autocomplete="off">
			</div>
...
<div class="search_resp"><div id="ctl30_pnl_SearchBox_1" class="SearchBox_1_Frame_CssClass">
		
    <div id="search_rs">
        
        
        <input name="ctl30$txb_SearchField" type="text" id="ctl30_txb_SearchField" class="SearchBox_1_SearchField_CssClass" onkeypress="button_click(this,&#39;ctl30_lkb_SearchButton&#39;)" placeholder="Chercher ..">
        <a id="ctl30_lkb_SearchButton" class="SearchBox_1_SearchButton_CssClass" href="javascript:__doPostBack(&#39;ctl30$lkb_SearchButton&#39;,&#39;&#39;)"></a>
    </div>

	</div></div>
<div class="top_menu_rs"><div id="ctl22_pnl_Menu_3">
		
    <div id="top_menu">
        <div id="ctl22_pnl_Main_Frame">
			
            <div id="ctl22_rm_Menu_3" class="RadMenu RadMenu_Metro rmSized top_menu" style="height: 0px; width: 0px; z-index: 7000;">
				<ul class="rmRootGroup rmToggleHandles rmHorizontal">
					<li class="rmItem rmFirst"><a class="rmLink rmRootLink item" href="http://www.meubleskarray.com/fr/services"><span class="rmText">Services</span></a></li><li class="rmItem "><a class="rmLink rmRootLink item" href="http://www.meubleskarray.com/fr/actualites"><span class="rmText">Actualités</span></a></li><li class="rmItem "><a class="rmLink rmRootLink item" href="http://www.meubleskarray.com/fr/espace_pro"><span class="rmText">Espace pro</span></a></li><li class="rmItem rmLast"><a class="rmLink rmRootLink item" href="contact.html"><span class="rmText">Contact</span></a></li>
				</ul><input id="ctl22_rm_Menu_3_ClientState" name="ctl22_rm_Menu_3_ClientState" type="hidden" autocomplete="off">
			</div>
