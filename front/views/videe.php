...
<table class="table table-bordered table-striped mb-none"  >
 ...
 <form method="POST" action="contt.php"></form>
                                        ...
                                        <td><?php echo $row["montantCommande"]." ZAYAN" ; ?></td>
...
<iframe scrolling="no" frameborder="0" allowtransparency="true" src="files/widget_iframe.2e9f365dae390394eb8d923cba8c5b11.html" title="Twitter settings iframe" style="display: none;"></iframe>
